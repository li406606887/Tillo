...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _modelBackgroundStyleColorAlpha = 0.3f; //自定义背景样式颜色透明度 默认为半透明背景样式 透明度为0.45f
...
//                label.font = [UIFont boldSystemFontOfSize:18.0f];
                ...
                label.textColor = [UIColor ALTextNormalColor];
...
//                label.textColor = [UIColor blackColor];
            ...
            case LEEItemTypeTextField:
            {
                ...
                [textField setValue:[UIColor ALTextLightColor]
                          forKeyPath:@"_placeholderLabel.textColor"];

                textField.backgroundColor = [UIColor ALGrayBgColor];
                [textField setBackground:[UIImage imageWithColor:[UIColor ALGrayBgColor]]];
               
                textField.frame = CGRectMake(0, 0, 0, 40.0f);
                textField.layer.masksToBounds = YES;
                textField.layer.borderColor = HEXCOLOR(0xeeeeee).CGColor;
...
//        if (!action.titleColor) action.titleColor = [UIColor colorWithRed:21/255.0f green:123/255.0f blue:245/255.0f alpha:1.0f];
        ...
        if (!action.titleColor) action.titleColor = [UIColor ALBlueColor];
