...
@interface YMDownloadItem (YMVideoDownloadDB)
...
@interface YMDownloadTask (YMVideoDownloadDB)
@property (nonatomic, assign) NSInteger pid;
@property (nonatomic, assign, readonly) NSUInteger createTime;
...
@implementation YMVideoDownloadDB
...
+ (void)initDatabase {
    _dbQueue = dispatch_queue_create("YMVideoDownloadDB_Queue", DISPATCH_QUEUE_SERIAL);
    
    //doc路径
    NSString *path = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, true).firstObject;
    
    path = [path stringByAppendingPathComponent:@"YMVideoDownload"];
    
    [YMDownloadUtils ym_createPathIfNotExist:path];
    
    path = [path stringByAppendingPathComponent:@"YMVideoDownload.db"];
