...
@interface YMDownloadItem (YMDownloadDB)
...
@interface YMDownloadTask (YMDownloadDB)
@property (nonatomic, assign) NSInteger pid;
@property (nonatomic, assign, readonly) NSUInteger createTime;
...
+ (void)initDatabase {
    _dbQueue = dispatch_queue_create("YMDownloadDB_Queue", DISPATCH_QUEUE_SERIAL);
    ...
    path = [path stringByAppendingPathComponent:@"YMDownload.db"];
