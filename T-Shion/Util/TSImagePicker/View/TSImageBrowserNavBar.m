...
- (void)resetSelectBtn:(NSInteger)currentIndex isSelected:(BOOL)isSelected {
    ...
    if (isSelected) {
        ...
        [self.selectedBtn setTitle:@"选中" forState:UIControlStateNormal];
    }
}
...
- (UIButton *)selectedBtn {
    if (!_selectedBtn) {
        ...
        [_selectedBtn setBackgroundImage:[UIImage imageWithColor:[UIColor ALBlueColor]] forState:UIControlStateSelected];
