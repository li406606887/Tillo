...
+ (YMImage *)imageWithContentsOfFile:(NSString *)path {
    return [[self alloc] initWithContentsOfFile:path];
}

+ (YMImage *)imageWithData:(NSData *)data {
    return [[self alloc] initWithData:data];
}

+ (YMImage *)imageWithData:(NSData *)data scale:(CGFloat)scale {
    return [[self alloc] initWithData:data scale:scale];
}
...
- (instancetype)initWithData:(NSData *)data scale:(CGFloat)scale {
    ...
    @autoreleasepool {
        ...
        BOOL decodeForDisplay = YMImageBrowseCellData.shouldDecodeAsynchronously;
        if (YMImageBrowseCellData.globalMaxTextureSize.width * YMImageBrowseCellData.globalMaxTextureSize.height < decoder.width * decoder.height) {
            decodeForDisplay = NO;
        }
