...
@property (strong, nonatomic) RACCommand *getSelfInfoCommand;//设置头像
@property (strong, nonatomic) RACCommand *getInfoCommand;//设置头像
...
@property (strong, nonatomic) RACSubject *getInfoSubject;//获取信息回调
@property (strong, nonatomic) RACSubject *clickAreaSubject;//选择国家代码
@property (strong, nonatomic) RACSubject *goBackSubject;//选择国家代码
@property (strong, nonatomic) RACSubject *agreementSubject;//设置昵称成功回调
@end
