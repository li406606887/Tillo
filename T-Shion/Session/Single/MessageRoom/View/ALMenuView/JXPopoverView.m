...
static float const kPopoverViewCellHeight = 40.0f; ///< cell指定高度
...
- (void)setStyle:(PopoverViewStyle)style {
    ...
    if (_style == PopoverViewStyleDefault) {
        ...
        self.backgroundColor = [UIColor colorWithRed:0.8 green:0.8 blue:0.8 alpha:1.00];
    }
}
...
- (void)initialize {
    ...
    if ([firstResponder isKindOfClass:[ALTextView class]]) {
...
//    [_keyWindow addSubview:_shadeView];
    ...
    currentW = currentW >80 ? currentW: 80;
    ...
    maskLayer.shadowRadius = 3.f;
    maskLayer.shadowOffset = CGSizeMake(0.f, 0.f);
    maskLayer.shadowOpacity = 0.1f;
...
- (CGFloat)calculateMaxWidth {
    CGFloat maxWidth = 0.f, titleLeftEdge = 0.f, imageWidth = 0.f;
